...
pub(super) fn read_agent(name: &str) -> String {
...
pub(super) async fn list_agents_tool<W>(_tx: &mut W) -> anyhow::Result<ToolCallOutcome>
where
    W: tokio::io::AsyncWriteExt + Unpin,
{
...
pub(super) async fn delete_agent<W, R>(
    id: &str,
    name: &str,
    is_ghost: bool,
    session_id: Option<&str>,
