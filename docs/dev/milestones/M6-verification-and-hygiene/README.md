...
| 04 | [audit-prompts-command](phase-04-audit-prompts-command.md) — the operator-facing `daemoneye audit-prompts`, report-only, never rewriting | in-progress (bounced, bug-04-4) |
