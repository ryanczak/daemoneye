...
| 07 | [artifact-lifecycle-policy](phase-07-artifact-lifecycle-policy.md) — **design-discovery**: one policy table covering every artifact class, with defaults; the test that fails on an uncovered class | todo |
