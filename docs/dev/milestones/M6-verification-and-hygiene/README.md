...
| 06b | [webhook-to-ghost-e2e](phase-06b-webhook-to-ghost-e2e.md) — observability seam for the ghost spawn + the pipeline scenario: severity-less payload through to `ghost_start` | review      |
