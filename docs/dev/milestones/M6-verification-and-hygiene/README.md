...
| 02 | [prompt-path-audit-test](phase-02-prompt-path-audit-test.md) — repo-side test that fails on any wrong or superseded path literal in the prompt and knowledge-memory assets | in-progress |
