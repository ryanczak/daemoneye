...
| 06g | tmux-off-runtime-scheduled-sudo ([phase-06g-tmux-off-runtime-scheduled-sudo.md](phase-06g-tmux-off-runtime-scheduled-sudo.md)) — `scheduled.rs` (7) + `utils/sudo.rs` (4) = 11. All async; introduces the `Err`-preserving collapse | review      |
