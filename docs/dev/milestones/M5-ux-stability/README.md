...
| 05g | compaction-coverage-followup ([phase-05g-compaction-coverage-followup.md](phase-05g-compaction-coverage-followup.md)) — 04f's 3 vacuous `compaction_in_flight` assertions made real, all 4 clearing sites mutation-checked. **Adds a test: 916** | todo |
