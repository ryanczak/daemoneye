...
| 06m | wrap-sync-fns-slice-2 ([phase-06m-wrap-sync-fns-slice-2.md](phase-06m-wrap-sync-fns-slice-2.md)) — 7 call sites: `detect_session` (1), `install_session_hooks` (2), `get_pane_remote_host` (2 — **a tmux call the scan cannot see**), `notify_chat_panes` (2, N subprocesses per call) | todo |
