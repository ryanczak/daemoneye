...
| 06e | tmux-off-runtime-foreground-3 ([phase-06e-tmux-off-runtime-foreground-3.md](phase-06e-tmux-off-runtime-foreground-3.md)) — `foreground.rs` **slice 3**, exit status & cleanup, 9 sites. Finishes the file | in-progress |
