...
| 06c | tmux-off-runtime-foreground ([phase-06c-tmux-off-runtime-foreground.md](phase-06c-tmux-off-runtime-foreground.md)) — `foreground.rs` **slice 1**, lines ≤460, 10 sites. Re-split after a `hard_fail` on 29-at-once | in-progress |
