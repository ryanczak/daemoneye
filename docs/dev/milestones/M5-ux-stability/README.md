...
| 06a | tmux-off-runtime ([phase-06a-tmux-off-runtime.md](phase-06a-tmux-off-runtime.md)) — the `off_runtime` adapter + `background/run.rs` (16 sites). **First of ~5** | in-progress |
