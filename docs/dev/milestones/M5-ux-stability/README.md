...
| 06f | tmux-off-runtime-executor-tail ([phase-06f-tmux-off-runtime-executor-tail.md](phase-06f-tmux-off-runtime-executor-tail.md)) — `knowledge/pane.rs` (7) + `file_ops/{mod,read}.rs` (5) = 12. Finishes `executor/` | in-progress |
