...
| 02 | staging-integration ([phase-02-staging-integration.md](phase-02-staging-integration.md)) | in-progress (bounced 2026-08-29, [bug-phase-02-1](bugs/bug-phase-02-1.md)) |
