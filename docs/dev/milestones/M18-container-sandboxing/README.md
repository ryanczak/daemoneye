...
|----|-------|--------|------------------|
| 01 | sandbox-config ([phase-01-sandbox-config.md](phase-01-sandbox-config.md)) | **in-progress** (drafted 2026-08-28) | `[sandbox]` config schema: `SandboxConfig` + limits + profiles + ghost defaults, parsing, validation, `assets/etc/config.toml` docs. Hermetic — no docker. |
