...
| 03b | [sweep-deletions](phase-03b-sweep-deletions.md) — `sweep_session_archives` and `sweep_event_segments` remove the rows for files they unlink | review      |
...
02a, 02b, 03a and 03b are drafted, 04–07 are not yet.
