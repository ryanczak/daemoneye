...
| 08 | [fts5-search](phase-08-fts5-search.md) — BM25 ranking wired into `ftsearch_memories()`, per-term query building, reconcile-on-empty, and the tag-miss/text-hit test | todo |
