...
| 09 | [index-doc-correction](phase-09-index-doc-correction.md) — correct five stale/never-true claims in `CLAUDE.md` and architecture.md, plus a tripwire so the retired ones cannot return | in-progress |
