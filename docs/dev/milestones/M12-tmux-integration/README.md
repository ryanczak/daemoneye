...
| 04 | [find-in-panes-tool](phase-04-find-in-panes-tool.md) — `find_in_panes` core tool (D4) ([bug-04-1](bugs/bug-04-1.md), [bug-04-2](bugs/bug-04-2.md)) | in-progress |
...
Phase docs are drafted one at a time via `/rexymcp:architect next`; 01–03 are
`done`, 04 is drafted (`todo`), 05–08 are not yet drafted.
