...
| 14 | split-background — split `daemon/background.rs` (1369) into `background/` : `helpers`, `run` (`run_background_in_window`), `respawn`, `gc` (completion notify + GC) ([phase-14-split-background.md](phase-14-split-background.md)) | review |
