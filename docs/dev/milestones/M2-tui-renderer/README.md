...
| 11 | interrupt-and-colors — two-press ESC/Ctrl+C interrupt of a streaming agent turn + blood-red border / deep-yellow title recolor of committed command-output panels (`commit_panel`) ([phase-11-interrupt-and-colors.md](phase-11-interrupt-and-colors.md)) | in-progress |
