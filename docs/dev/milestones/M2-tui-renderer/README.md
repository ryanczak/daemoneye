...
| 10 | input-editor — visible cursor + word-wrap + multi-line editing + multi-line paste in the ratatui input box ([phase-10-input-editor.md](phase-10-input-editor.md)) | in-progress (bug-phase-10-1) |
