...
| 05a | epoch-persistence ([phase-05a-epoch-persistence.md](phase-05a-epoch-persistence.md)) — `context/epochs.rs` types, append-only persistence, span-windowed tally/scan (additive) | core | todo |
