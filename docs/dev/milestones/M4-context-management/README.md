...
| #  | Phase | Theme | Status |
|----|-------|-------|--------|
| 01 | events-rotation ([phase-01-events-rotation.md](phase-01-events-rotation.md)) — dated event segments, shared streaming readers, retention sweep | hygiene | review ||
