...
| 04 | append-only-archive ([phase-04-append-only-archive.md](phase-04-append-only-archive.md)) — `<id>.archive.jsonl`, honest elision placeholders, retention | core | review |
